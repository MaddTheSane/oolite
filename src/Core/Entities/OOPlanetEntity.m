...
- (instancetype) initFromDictionary:(NSDictionary *)dict withAtmosphere:(BOOL)atmosphere andSeed:(Random_Seed)seed forSystem:(OOSystemID)systemID
{
	...
	[planetInfo setObject:@(0.01 * percent_land) forKey:@"land_fraction"];

	int percent_ice = [planetInfo oo_intForKey:@"percent_ice" defaultValue:5];
	[planetInfo setObject:@(0.01 * percent_ice) forKey:@"polar_fraction"];
	...
	if (atmosphere)
	{
		...
		[planetInfo setObject:@(0.01 * percent_land) forKey:@"cloud_fraction"];
		...
		_materialParameters = [planetInfo dictionaryWithValuesForKeys:@[@"cloud_fraction", @"air_color",  @"cloud_color", @"polar_cloud_color", @"cloud_alpha", @"land_fraction", @"land_color", @"sea_color", @"polar_land_color", @"polar_sea_color", @"noise_map_seed", @"economy", @"polar_fraction", @"isMiniature", @"perlin_3d"]];
	}
	else
#else
...
#endif
	{
		_materialParameters = [planetInfo dictionaryWithValuesForKeys:@[@"land_fraction", @"land_color", @"sea_color", @"polar_land_color", @"polar_sea_color", @"noise_map_seed", @"economy", @"polar_fraction",  @"isMiniature", @"perlin_3d"]];
	}
...
- (void) setUpColorParametersWithSourceInfo:(NSDictionary *)sourceInfo targetInfo:(NSMutableDictionary *)targetInfo isAtmosphere:(BOOL)isAtmosphere
{
	...
	else
	{
		...
		[targetInfo setObject:@(cloudAlpha) forKey:@"cloud_alpha"];
...
- (void) setTextureFileName:(NSString *)textureName
{
	...
	if (shadersOn)
	{
		...
		[config setObject:@[diffuseMap, normalMap] forKey:@"_oo_texture_objects"];
